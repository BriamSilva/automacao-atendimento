...
if (!encontrado) {
    ...
    responder(client, message.from, `Olá ${pessoaNova.nome} sou Ava sua atendente virtual.\n
  Antes de iniciar, me informe nome completo, por favor`);
} else {
    responder(client, message.from, `Olá ${pessoaNova.nome}, seja bem vindo novamente.\n
  Segue o nossos procedimentos...`);
}
